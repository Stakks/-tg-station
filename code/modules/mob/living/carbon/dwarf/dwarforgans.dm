...
/mob/living/carbon/dwarf/proc/getBooze()
...
/mob/living/carbon/dwarf/proc/updateBoozeDisplay()
...
/obj/item/organ/internal/dwarf/liver/on_life()
	if(istype(owner, /mob/living/carbon/dwarf))
		if(storedBooze >= 300)
			if(istype(owner, /mob/living/carbon/dwarf))
