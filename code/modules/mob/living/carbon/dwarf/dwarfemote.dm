/mob/living/carbon/dwarf/emote(var/act,var/m_type=1,var/message = null)
	var/param = null
	...
	switch(act) //Please keep this alphabetically ordered when adding or changing emotes.
		...
		if ("dwarfgasp")
			message = "<B>[src]</B> has been struck down..."
			m_type = 1
