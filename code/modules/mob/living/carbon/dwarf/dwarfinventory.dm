/mob/living/carbon/dwarf/can_equip(obj/item/I, slot, disable_warning = 0)
	if(dna)
...
/mob/living/carbon/dwarf/verb/quick_equip()
...
/mob/living/carbon/dwarf/proc/equip_in_one_of_slots(obj/item/I, list/slots, qdel_on_fail = 1)
...
/mob/living/carbon/dwarf/get_item_by_slot(slot_id)
	switch(slot_id)
		if(slot_back)
			return back
		if(slot_wear_mask)
...
/mob/living/carbon/dwarf/unEquip(obj/item/I)
...
/mob/living/carbon/dwarf/equip_to_slot(obj/item/I, slot, redraw_mob = 1)
	if(!slot)	return
	if(!istype(I))	return
...
/mob/living/carbon/dwarf/get_multitool(var/active_only=0)
