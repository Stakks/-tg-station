...
var/list/bloodtypes_dwarf = list("D")
var/const/BLOOD_VOLUME_SAFE_DWARF = 501
var/const/BLOOD_VOLUME_OKAY_DWARF = 336
var/const/BLOOD_VOLUME_BAD_DWARF = 224
var/const/BLOOD_VOLUME_SURVIVE_DWARF = 122

/mob/living/carbon/dwarf/var/datum/reagents/vessel	//Container for blood and BLOOD ONLY. Do not transfer other chems here.
/mob/living/carbon/dwarf/var/pale = 0			//Should affect how mob sprite is drawn, but currently doesn't.

//Initializes blood vessels
/mob/living/carbon/dwarf/proc/make_blood()

	if(vessel)
		return

	vessel = new/datum/reagents(800)
	vessel.my_atom = src

	if(NOBLOOD in dna.species.specflags)
		return

	vessel.add_reagent("blood",800)
	spawn(1)
		fixblood()

//Resets blood data
/mob/living/carbon/dwarf/proc/fixblood()
...
/mob/living/carbon/dwarf/proc/suppress_bloodloss(var/amount)
	if(bleedsuppress)
		return
	else
		bleedsuppress = 1
...
/mob/living/carbon/dwarf/handle_blood()
...
/mob/living/carbon/dwarf/proc/drip(var/amt as num)
...
/mob/living/carbon/proc/take_blood_dwarf(obj/item/weapon/reagent_containers/container, var/amount)
...
/mob/living/carbon/dwarf/take_blood(obj/item/weapon/reagent_containers/container, var/amount)
...
/mob/living/carbon/proc/inject_blood_dwarf(obj/item/weapon/reagent_containers/container, var/amount)
	...
	for(var/C in chems)
		src.reagents.add_reagent(C, (text2num(chems[C]) / 800) * amount)//adds trace chemicals to owner's blood
	reagents.update_total()

	container.reagents.remove_reagent("blood", amount)

//Transfers blood from container to vessels, respecting blood types compatibility.
/mob/living/carbon/dwarf/inject_blood(obj/item/weapon/reagent_containers/container, var/amount)
...
/mob/living/carbon/proc/get_blood_dwarf(datum/reagents/container)
...
dwarf/proc/blood_incompatible(donor,receiver,donor_species,receiver_species)
...
dwarf/proc/blood_splatter(var/target,var/datum/reagent/blood/source,var/large)

	var/obj/effect/decal/cleanable/blood/B
	var/decal_type = /obj/effect/decal/cleanable/blood/splatter
	var/turf/T = get_turf(target)

	if(istype(source,/mob/living/carbon/dwarf))
		var/mob/living/carbon/dwarf/M = source
