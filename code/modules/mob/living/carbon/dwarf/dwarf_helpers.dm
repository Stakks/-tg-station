/mob/living/carbon/dwarf/restrained()
...
/mob/living/carbon/dwarf/canBeHandcuffed()
	var/datum/organ/limb/LH = get_organdatum("l_arm")
	var/datum/organ/limb/RH = get_organdatum("r_arm")
...
/mob/living/carbon/dwarf/proc/get_assignment(var/if_no_id = "No id", var/if_no_job = "No job")
...
//Useful when player do something with computers
/mob/living/carbon/dwarf/proc/get_authentification_name(var/if_no_id = "Unknown")
	var/obj/item/weapon/card/id/id = get_idcard()
	if(id)
...
/mob/living/carbon/dwarf/get_visible_name()
...
/mob/living/carbon/dwarf/proc/get_face_name(if_no_face="Unknown")
...
/mob/living/carbon/dwarf/proc/get_id_name(var/if_no_id = "Unknown")
...
/mob/living/carbon/dwarf/proc/get_idcard()
	if(wear_id)
		return wear_id.GetID()

///checkeyeprot()
///Returns a number between -1 to 2
/mob/living/carbon/dwarf/check_eye_prot()
	var/number = ..()
...
/mob/living/carbon/dwarf/check_ear_prot()
...
/mob/living/carbon/dwarf/tintcheck()
	var/tinted = 0
...
/mob/living/carbon/dwarf/abiotic(var/full_body = 0)
...
/mob/living/carbon/dwarf/IsAdvancedToolUser()
	return 1//Humans can use guns and such

/mob/living/carbon/dwarf/SpeciesCanConsume()
	return 1 // Humans can eat, drink, and be forced to do so

/mob/living/carbon/dwarf/InCritical()
	return (health <= config.health_threshold_crit && stat == UNCONSCIOUS)

/mob/living/carbon/dwarf/reagent_check(datum/reagent/R)
	if(dna)
...
/mob/living/carbon/dwarf/get_permeability_protection()
